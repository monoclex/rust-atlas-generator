...
/**
 * @typedef SnowpackRustAtlasGeneratorOptions
...
/**
 * @param {import("snowpack").SnowpackConfig} config
 * @param {SnowpackRustAtlasGeneratorOptions} options
 * @returns {import("snowpack").SnowpackPlugin}
 */
module.exports = function rustAtlasGeneratorPlugin(config, options) {
	...
	// TODO: support regenerating atlas on new file
	return {
		name: "snowpack-plugin-rust-atlas-generator",
		async run() {
